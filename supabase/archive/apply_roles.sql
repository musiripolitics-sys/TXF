-- ============================================================
-- Techxfluence — APPLY ROLES (idempotent)
-- Combines migrations 0002 + 0003 + 0004. Safe to run multiple
-- times. Run once in the Supabase SQL Editor.
-- ============================================================
...
-- ---------- Capture profile + role at signup ----------
